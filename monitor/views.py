...
def get_memory_info(request):
    return JsonResponse({
        ...
        "used_memory": psutil.virtual_memory().used / (1024.0 ** 2),
...
def resources(request):
    ...
    return render(request,'resources.html',{
        "kernel_version": os.uname().release.capitalize(),
        "system_name": os.uname().sysname.capitalize(),
        "node_name": os.uname().nodename.capitalize(),
